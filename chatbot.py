"""
Made with streamlit By Kaeyros Analytics Teams
...
icons = {
    "assistant": "img/assistant-done.svg",
    "user": "img/user-done.svg",
}
...
st.set_page_config(page_title="Kaeyros.AI", page_icon="✨", layout="wide")

welcome_messages = [
    "Hello! I'm Kaeyros, an AI assistant designed to make image metadata meaningful. Ask me anything!",
    "Hi! I'm Kaeyros, an AI-powered assistant for extracting and explaining load data. How can I help you today?",
    "Hey! I'm Kaeyros, your AI-powered guide to understanding the metadata in your images. What would you like to explore?",
    "Hi there! I'm Kaeyros, an AI-powered tool built to help you make sense of your image metadata. How can I help you today?",
    "Hello! I'm Kaeyros, an AI-driven tool designed to help you understand your images' metadata. What can I do for you?",
    "Hi! I'm Kaeyros, an AI-driven assistant designed to make load data easy to understand. How can I help you today?",
    "Welcome! I'm Kaeyros, an intelligent AI-powered tool for extracting and explaining load data. How can I assist you today?",
    "Hello! I'm Kaeyros, your AI-powered guide for understanding image metadata. Ask me anything!",
    "Hi! I'm Kaeyros, an intelligent AI assistant ready to help you understand your images' metadata. What would you like to explore?",
    "Hey! I'm Kaeyros, an AI assistant for extracting and explaining Load data. How can I help you today?",
]
...
with st.sidebar:
    ...
    st.markdown(
        ...
        <div style='display: flex; align-items: center;'>
            ...
            <h1 style='margin: 0;'>Kaeyros.AI</h1>
        </div>
        """,
    ...
    with expander:
        ...
        image_url = st.text_input(
            "Enter image URL for DATA analysis:",
            key="image_url",
    ...
    You are an expert data Analyser. The user will provide an image file and you will explain the file data in verbose detail.
    
    Pay careful attention to the data of the data image and create a profile for the user who took this image. 
    
    1. Make inferences on things like location, budget, experience, etc. (2 paragraphs) 
    2. Make as many inferences as possible about the data in the next 3 paragraphs.
...
st.sidebar.caption(
    "Built by [Kaeyros Analytics](https://kaeyros-analytics.com/). Like this? [Hire me!](https://kaeyros-analytics.com/)"
)
